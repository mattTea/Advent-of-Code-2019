...
private fun opCodeOf1(input: List<Int>): List<Int> {
    val positionToReplace = input[3]
    val replaceWith = input[input[1]] + input[input[2]]
...
private fun opCodeOf2(input: List<Int>): List<Int> {
    val positionToReplace = input[3]
    val replaceWith = input[input[1]] * input[input[2]]
